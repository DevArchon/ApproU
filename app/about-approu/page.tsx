...
export const metadata: Metadata = {
  title: "About approU",
  description: "Learn about approU - Canada's trusted mortgage platform connecting homebuyers with expert brokers.",
};

export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <h1 className="text-4xl font-bold mb-6">About approU</h1>
      
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          approU is Canada's leading mortgage platform, connecting homebuyers with trusted mortgage professionals across the country.
        </p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Why Choose approU?</h2>
        <p>
